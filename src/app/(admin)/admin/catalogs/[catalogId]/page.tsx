...
export default async function AdminCatalogDetailPage({
  ...
  return (
    <div className="space-y-8">
      <div>
        <Link className="text-sm text-muted-foreground hover:underline" href="/admin/catalogs">
          Torna ai cataloghi
        </Link>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between gap-3 space-y-0">
          ...
          <Link
            ...
            href={`/admin/catalogs/${catalog.id}/activations/new`}
          >
            Nuova attivazione
          </Link>
        </CardHeader>
                  ...
                  <TableRow key={a.id}>
                    ...
                    <TableCell className="text-right">
                      <Link
                        ...
                        href={`/admin/catalogs/${catalog.id}/activations/${a.id}`}
                      >
                        Modifica
                      </Link>
                    </TableCell>
