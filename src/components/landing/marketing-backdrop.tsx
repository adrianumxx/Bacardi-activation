    ...
    return (
      <>
        <div
          ...
          aria-hidden
        >
          <div className="absolute inset-0 bg-[radial-gradient(85%_50%_at_50%_-20%,rgba(217,30,39,0.22),transparent_55%)]" />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,transparent_45%,rgba(217,30,39,0.06)_100%)]" />
        </div>
        <div
  ...
  return (
    <>
      <div
        ...
        aria-hidden
      >
        <div className="absolute inset-0 bg-[radial-gradient(100%_70%_at_10%_-10%,rgba(217,30,39,0.35),transparent_52%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(80%_55%_at_95%_15%,rgba(217,30,39,0.18),transparent_48%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(168deg,rgba(0,0,0,0)_35%,rgba(217,30,39,0.08)_100%)]" />
      </div>
      <div
